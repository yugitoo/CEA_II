...
<!-- col_box <- c("idade","n_doencas_associadas","escolaridade","ave_meses") -->
<!-- layout(matrix(c(1,2,3,4,5,6), ncol=3, byrow=TRUE), heights=c(3, 3)) -->
...
<!--     plot(density(na.omit(j)), main = paste0(i," geral")) -->
<!--   } -->
<!-- layout(matrix(c(1,1,1), ncol=3, byrow=TRUE), heights=c(3)) -->
