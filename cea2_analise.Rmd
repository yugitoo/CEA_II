...
library(agricolae)
mod_2 <- lm(bd$tr_media_sem_distrator~bd$trail_b_tempo+bd$velocidade_processamento_tempo+bd$inibição_total+bd$flexibilidade_tempo+bd$grupo, data = bd)
# summary(mod_2)
...
plot(out, variation = 'SD', main= "Teste LSD - Grupos e Desvio Padrão")
